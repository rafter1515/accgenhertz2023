...
class Client(Callbacks, SocketHandler):
    def __init__(self, deviceId: str = None, proxies: dict = None, certificatePath=None, socket_trace=False,
                 socketDebugging=False, socket_enabled=True, autoDevice=False):
    ...
    def parse_headers(self, data: str = None, type: str = None):
        return headers.ApisHeaders(deviceId=deviceId() if self.autoDevice else self.device_id, data=data,
                                   type=type).headers
    ...
    def register(self, nickname: str, email: str, password: str, verificationCode: str,
                 deviceId: str = device.device_id, timeout: int = None):
        """
        Register an account.
    ...
    def request_verify_code(self, email: str, dev: str, resetPassword: bool = False, timeout: int = None):
        """
